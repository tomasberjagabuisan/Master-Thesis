#!/bin/bash
#SBATCH --job-name=DMF_MCS       
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem-per-cpu=2G
#SBATCH --cpus-per-task=1
#SBATCH --array=1-101
#SBATCH --output=DMF_MCS%A_%a.out
#SBATCH --error=DMF_MCS%A_%a.err
...
C=SC; %Normalized
N=90;  % # parcells
NSUB=11; % # Subjects in the empirical data set 
NSUBSIM=11; % # simulation
...
%%%
save(sprintf('DMF_TS_MCS_%d.mat',s),'FC','FCD','FC_euclidian','FC_euclidian2','FC_Ssim','hh','pp');
