#!/bin/bash
#SBATCH --job-name=DMF_C       
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem-per-cpu=2G
#SBATCH --cpus-per-task=1
#SBATCH --array=1-101
#SBATCH --output=DMF_C%A_%a.out
#SBATCH --error=DMF_C%A_%a.err
...
C=SC; %Normalized
N=90;  % # parcells
NSUB=13; % # Subjects in the empirical data set 
NSUBSIM=13; % # simulation
...
%%%
save(sprintf('DMF_TS_C_%d.mat',s),'FC','FCD','FC_euclidian','FC_euclidian2','FC_Ssim','hh','pp');
