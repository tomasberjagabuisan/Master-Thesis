#!/bin/bash
#SBATCH --job-name=DMF_N3       
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem-per-cpu=2G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=DMF_N3%A_%a.out
#SBATCH --error=DMF_N3%A_%a.err
...
C=SC; %Normalized
N=90;  % # parcells
NSUB=15; % # Subjects in the empirical data set 
...
save(sprintf('DMF_TS_N3_%d.mat',s),'FC','FCD','FC_euclidian','FC_euclidian2','FC_Ssim','hh','pp');
