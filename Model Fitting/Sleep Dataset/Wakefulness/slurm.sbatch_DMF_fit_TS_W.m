#!/bin/bash
#SBATCH --job-name=DMF_W       
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem-per-cpu=2G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=DMF_W%A_%a.out
#SBATCH --error=DMF_W%A_%a.err
...
save(sprintf('DMF_TS_W_%d.mat',s),'FC','FCD','FC_euclidian','FC_euclidian2','FC_Ssim','hh','pp');
